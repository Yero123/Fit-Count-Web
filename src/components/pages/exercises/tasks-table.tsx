...
import { useExerciseTable } from "@/hooks/useExerciseTable";

export function TasksTable() {
  // Feature flags for showcasing some additional features. Feel free to remove them.
  const { featureFlags } = useTasksTable();

  const { data, pageCount } = useExerciseTable();
   ...
   */
  const filterFields: DataTableFilterField<Exercise>[] = [
    {
      label: "Nombre",
      value: "name",
